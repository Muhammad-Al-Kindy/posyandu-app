      ...
      <div class="card-body container-fluid">
         <form method="post" action="/home/store">
          ...
          <div class="form-group">
             ...
             <input type="text" placeholder="ex: Wahyu Aji" class="form-control @error('nama') is-invalid @enderror" id="nama" name="nama" data-toggle="tooltip" data-placement="right" title="Nama Lengkap Bayi" value="{{ old('nama') }}" autofocus>
             @error('nama')<div class="invalid-feedback ml-1">Bidang ini wajib diisi</div>@enderror
          </div>
          <div class="form-group">
             <label for="email">Alamat Email</label>
             <input type="text" placeholder="ex: staff@posyandu.com" class="form-control @error('email') is-invalid @enderror" id="email" name="email" data-toggle="tooltip" data-placement="right" title="Alamat email" value="{{ old('email') }}">
