        ...
        <div class="row">
          <div class="col-xl-6 mr-auto">
            <div class="form-group">
              ...
              <input type="text" placeholder="NIK Bayi" class="form-control fs-normal form-spacer-20x15 @error('nik_bayi') is-invalid @enderror" id="nik_bayi" name="nik_bayi" data-toggle="tooltip" data-placement="right" title="NIK Bayi" value="{{ old('nik_bayi') }}" autofocus>
              @error('nik_bayi')
            ...
            <div class="form-group">
              ...
              <input type="text" placeholder="NIK Ayah" class="form-control fs-normal form-spacer-20x15 @error('nik_ayah') is-invalid @enderror" id="nik_ayah" name="nik_ayah" data-toggle="tooltip" data-placement="right" title="NIK Ayah" value="{{ old('nik_ayah') }}">
              @error('nik_ayah')
                <div class="invalid-feedback ml-1">Bidang ini wajib diisi</div>
              @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" placeholder="Pekerjaan Ayah" class="form-control fs-normal form-spacer-20x15 @error('pekerjaan_ayah') is-invalid @enderror" id="pekerjaan_ayah" name="pekerjaan_ayah" data-toggle="tooltip" data-placement="right" title="Pekerjaan Ayah" value="{{ old('pekerjaan_ayah') }}">
          ...
          <div class="col-xl-6 ml-auto">
            ...
            <div class="form-group">
              ...
              <input type="text" placeholder="NIK Ibu" class="form-control fs-normal form-spacer-20x15 @error('nik_ibu') is-invalid @enderror" id="nik_ibu" name="nik_ibu" data-toggle="tooltip" data-placement="right" title="NIK Ibu Bayi" value="{{ old('nik_ibu') }}">
              @error('nik_ibu')
              <div class="invalid-feedback ml-1">Bidang ini wajib diisi</div>
              @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" placeholder="Pekerjaan Ibu" class="form-control fs-normal form-spacer-20x15 @error('pekerjaan_ibu') is-invalid @enderror" id="pekerjaan_ibu" name="pekerjaan_ibu" data-toggle="tooltip" data-placement="right" title="Pekerjaan Ibu Bayi" value="{{ old('pekerjaan_ibu') }}">
                @error('pekerjaan_ibu')
                  <div class="invalid-feedback ml-1">Bidang ini wajib diisi</div>
                @enderror
              </div>
