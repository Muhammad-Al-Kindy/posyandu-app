...
<head>
  ...
  <link rel="stylesheet" href="./ui/style/style-red.css">
  ...
  <nav id="head" class="navbar nav navbar-expand-lg fixed-top" onscroll="Scroll()">
    ...
    <div class="collapse pl-5 navbar-collapse" id="navbarSupportedContent">
      ...
      <div class="form-inline pr-15 my-2 my-lg-0">
        <a href="/" class="btn btn-app">Masuk</a>
      </div>
    </div>
  </nav>
...
<section class="content">
  ...
  <div class="main-top">
    ...
    <div id="beranda" class="main-banner">
      ...
      <div class="right-banner">
        <img src="./ui/svg/banner/red-banner.svg" class="banner-img mb-10" alt="">
      </div>
    </div>
    <!-- END BANNER -->
        ...
        <div class="row pl-15 pr-15">
            ...
            <a href="#" class="link-services">
              <div class="card box-shadow" style="width: 100%; height: auto">
                <div class="card-body m-2 text-center">
                  <img src="./ui/svg/icon/red-holding-heart.svg" class="mb-4" alt="">
          ...
          <div class="col-md-4">
            <a href="#" data-toggle="modal" data-target="#exampleModalLong" class="link-services">
              <div class="card box-shadow" style="width: 100%; height: auto">
                <div class="card-body m-2 text-center">
                  <img src="./ui/svg/icon/red-simple-clockify.svg" class="mb-4" alt="">
          ...
          <div class="col-md-4">
            <a href="#" class="link-services">
              <div class="card box-shadow" style="width: 100%; height: auto;">
                <div class="card-body m-2 text-center">
                  <img src="./ui/svg/icon/red-awesome-heartbeat.svg" class="mb-4" alt="">
  ...
  <div id="teori" class="teori">
    ...
    <div class="left-teori">
      <img src="./ui/svg/teori/red-teori.svg" class="teori-img" alt="">
    </div>
  ...
  <div class="main-bottom">
    ...
    <div id="about" class="about">
      ...
      <div class="right-about text-right">
        <img src="./ui/svg/about/red-about.svg" class="about-img" alt="">
      </div>
    </div>
    <!-- END ABOUT -->
    <br>
