...
<div class="container fs-normal">
   ...
   <!-- Page Heading -->
   <p class="mb-3">Tabel / Data / <span class="color-primary">Profile</span></p>
  <div class="row">
    <div class="col-md-6">
      <h5 class="m-0 font-weight-bold color-primary mb-2">Profile Saya</h5>
   ...
   <div class="card shadow-sm border-0 mb-4">
      ...
      <div class="card-body container-fluid">
        ...
        @endif
         ...
         <form method="post" action="{{ url('/home/'. $user->id).'/profile' }}">
          @csrf
          @method('PUT')
         ...
         <div class="form-group row">
            <div class="col-md-4">
             ...
             <select id="role" disabled name="role" class="form-control-select fs-normal form-spacer-10x8 @error('role') is-invalid @enderror" data-toggle="tooltip" data-placement="right" title="Golongan Darah Bayi">
            ...
            <div class="col-md-4">
             ...
             <input type="password" class="form-control fs-normal form-spacer-20x15 @error('password') is-invalid @enderror" id="password" name="password" placeholder="Password" data-toggle="tooltip" data-placement="right" title="Password">
