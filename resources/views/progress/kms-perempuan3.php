...
var myLineChart = new Chart(ctx, {
  ...
  data: {
    ...
    datasets: [
      ...
      pointHitRadius: 10,
      pointBorderWidth: 1,
      data: [14.9, 15.1, 15.4, 15.7, 16, 16.3, 16.5, 16.8, 17.1, 17.3, 17.6, 17.9, 18.1],
      },
      {
      ...
      pointHitRadius: 10,
      pointBorderWidth: 1,
      data: [13, 13.3, 13.5, 13.7, 14, 14.2, 14.4, 14.7, 14.9, 15.1, 15.3, 15.6, 15.8],
      },
      {
      label: "Ideal",
      lineTension: 0.3,
      ...
      pointHitRadius: 10,
      pointBorderWidth: 1,
      data: [11.5, 11.7, 11.9, 12.1, 12.3, 12.5, 12.7, 12.9, 13.1, 13.3, 13.5, 13.7, 13.85],
      },
      {
      ...
      pointHitRadius: 10,
      pointBorderWidth: 1,
      data: [10.1, 10.3, 10.5, 10.7, 10.9, 11.05, 11.2, 11.35, 11.55, 11.75, 11.9, 12, 12.2],
      },
      {
      label: "Terlalu Kurus",
      lineTension: 0.3,
      ...
      pointHitRadius: 10,
      pointBorderWidth: 1,
      data: [9, 9.2, 9.35, 9.5, 9.65, 9.8, 10, 10.1, 10.2, 10.4, 10.6, 10.7, 10.8],
      },
    ],
  },
  options: {
