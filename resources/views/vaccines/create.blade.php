...
<div class="container fs-normal">
  ...
  <div class="row">
    <div class="col-md-6">
      <h5 class="m-0 font-weight-bold color-primary mb-2">Tambah Vaksin</h5>
   ...
   <div class="card shadow mb-4 border-0">
      ...
      <div class="card-body container-fluid">
         <form method="post" action="/vaccine/store">
          @csrf
          <div class="form-group">
             <label for="name">Nama Jenis Vaksin</label>
             <input type="text" placeholder="ex: BCG (Bacillus Calmette Guerin)" class="form-control fs-normal form-spacer-20x15 @error('name') is-invalid @enderror" id="name" name="name" data-toggle="tooltip" data-placement="right" title="name Lengkap Bayi" value="{{ old('name') }}" autofocus>
             @error('name')<div class="invalid-feedback ml-1">Bidang ini wajib diisi</div>@enderror
          </div>
          <div class="form-group">
             <label for="description">Deskripsi</label>
             <textarea name="description" placeholder="ex: Deskripsi vaksin" class="form-control fs-normal form-spacer-20x15 @error('description') is-invalid @enderror" id="description" id="description">{{ old('description') }}</textarea>
