      ...
      <div class="card-body container-fluid">
         <form method="post" action="/vaccine/{{ $vaccine->id }}">
          ...
          <div class="form-group">
             ...
             <input type="text" placeholder="ex: BCG (Bacillus Calmette Guerin)" class="form-control fs-normal form-spacer-20x15 @error('name') is-invalid @enderror" id="name" name="name" data-toggle="tooltip" data-placement="right" title="name Lengkap Bayi" value="{{ $vaccine->name }}" autofocus>
