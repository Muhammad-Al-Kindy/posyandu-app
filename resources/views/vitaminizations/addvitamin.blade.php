  ...
  @endif
   ...
   <div class="card shadow mb-4 border-0">
      <div class="card-header bg-white py-3">
         <h6 class="m-0 font-weight-bold color-primary">Data Vitaminisasi - {{ $vit->name }}</h6>
      </div>
      <div class="card-body container-fluid">
         <form method="post" action="/vitaminization/{{ $baby->id }}/add">
          @csrf
          ...
          <div class="form-group row">
            <div class="col-md-4">
              ...
              <input type="hidden" name="id_vitamin" value="{{ $vit->id }}">
              <input type="text" readonly class="form-control fs-normal form-spacer-20x15 @error('vitamin') is-invalid @enderror" id="vaccine" name="vaccine" data-toggle="tooltip" data-placement="right" title="Bulan Bayi" value="{{ $vit->name }}" autofocus>
